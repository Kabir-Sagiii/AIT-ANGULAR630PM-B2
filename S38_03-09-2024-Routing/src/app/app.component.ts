...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,HeaderComponent,FooterComponent,AComponent,BComponent,ContentchildrenComponent,ViewchildComponent, ProductsComponent, NgcontentComponent, GithubHomeComponent, NgtemplateComponent, NgcontainerComponent, ContentchildComponent],
